...
Private Sub Form_Load()
  ...
  'el JCFramework pero nada de este formulario, ni de esta aplicacion.
  ...
  'to change the code in the JCFramework but anything in this form,
...
Private Sub CargarGrilla()
  ...
  Set cursor = retrieveCriteria.perform(cliente, colParams)
  While cursor.hasElements
    cursor.loadObject cliente
...
Private Sub CargarPaises()
  ...
  indice = 0
  Dim colParams As New Collection
  Set cursor = retrieveCriteria.perform(aCountry, colParams)
  While cursor.hasElements
    cursor.loadObject aCountry
